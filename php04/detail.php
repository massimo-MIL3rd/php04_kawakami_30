...
//２．データ登録SQL作成
$stmt   = $pdo->prepare("SELECT * FROM gs_map_table WHERE id=:id"); //SQLをセット
...
<form method="post" action="update.php">
  <div class="jumbotron">
   <fieldset>
    <legend>営業履歴</legend>
	   <label>緯度経度：<input id="currentPosi" type="shown" name="position" value ="<?=$row["currentPosi"]?>"></label><br>
     <label>物件名称：<input type="text" name="buildingName" value="<?=$row["buildingName"]?>"></label><br>
     <label>担当者名：<input type="text" name="name" value="<?=$row["name"]?>"></label><br>
